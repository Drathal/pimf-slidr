...
$config_app = array(
  ...
  */
  ...
  /*
  |------------------------------------------------------------------------
  | View settings for main and Twig template engines
  |------------------------------------------------------------------------
  */
  'view' => array(
    'twig' => array(
  ...
  */
  'production' => array(
    ...
    //'db' => array(
    //  'driver' => 'sqlite',
    //  'database' => 'app/main/_database/production.db'
    //),
  ...
  */
  'session' => array(
      ...
      'storage_path' => 'app/main/_session/',

      // If using the PDO (database) session storage
      'database' => array(
        //'driver' => 'sqlite',
        //'database' => 'app/main/_session/session.db',
      ),
  ...
  */
  'cache' => array(
      ...
      // If using file storage - default is null
      'storage_path' => 'app/main/_cache/',

      // If using the PDO (database) cache storage
      'database' => array(
        //'driver' => 'sqlite',
        //'database' => 'app/main/_cache/cache.db',
      ),
